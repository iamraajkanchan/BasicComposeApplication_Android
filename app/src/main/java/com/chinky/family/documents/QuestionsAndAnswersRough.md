...
1. What is Retrofit and how does it work in Android?
    - A type-safe HTTP client built for Android and Java.
    - Developed by Square. 
    - Simplifies network operations
    - Allow developers to define REST API calls
    - Uses interfaces and annotations to make request.
2. How do you define a Retrofit interface for API calls?
   - Create an interface with methods which are annotated with HTTP verbs like @GET, @POST, etc. Each method represents an API endpoint.
