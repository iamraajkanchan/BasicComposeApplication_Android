...
class LazyColumnDemoActivity : ComponentActivity() {
    ...
    private fun DisplayVariousLazyColumnOptions(padding: PaddingValues) {
        Column(
            ...
            Button(onClick = {
                val intent = Intent(this@LazyColumnDemoActivity, com.chinky.family.presentation.composableFunctions.activities.LazyColumnWithSearchDemoActivity::class.java)
                startActivity(intent)
            }) {
