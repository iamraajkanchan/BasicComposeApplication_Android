        ...
        Column(
                ...
                Button(
                    ...
                    onClick = {
                        val textActivityIntent = Intent(
                            ...
                            com.chinky.family.presentation.composableFunctions.activities.CircularProgressIndicatorDemoActivity::class.java
                        )
                        startActivity(textActivityIntent)
                    }
                ) {
            ...
            Row {
                Button(
                    ...
                    onClick = {
                        val textActivityIntent =
                            Intent(this@ComposableMenuActivity, com.chinky.family.presentation.composableFunctions.activities.IconDemoActivity::class.java)
                        startActivity(textActivityIntent)
                    }
                ) {
                    Text("Icon")
            ...
            Row {
                Button(
                    ...
                    onClick = {
                        val textActivityIntent =
                            Intent(this@ComposableMenuActivity, com.chinky.family.presentation.composableFunctions.activities.RowDemoActivity::class.java)
                        startActivity(textActivityIntent)
                    }
                ) {
                    Text("Row")
